...
- **Third-party apps** (`Screenize`, `Pixiv-SwiftUI`, `FluidVoice`, `WiiUDownloader`, `NotchPrompt`, `i4Tools`): synced automatically from their latest GitHub releases via a scheduled workflow in this repo.
