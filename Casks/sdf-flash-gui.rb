cask "sdf-flash-gui" do
  ...
  on_arm do
    ...
    url "https://github.com/thedavidweng/sdf-flash-gui/releases/download/v0.4.0/SDF.Flash.GUI_0.4.0_aarch64.dmg"
  end
  on_intel do
    sha256 "ae916882801c358c67eb5e41a8d8aff3ba5bc9e40985cb5f6d64d2f7804b564c"
    url "https://github.com/thedavidweng/sdf-flash-gui/releases/download/v0.4.0/SDF.Flash.GUI_0.4.0_x64.dmg"
  end
